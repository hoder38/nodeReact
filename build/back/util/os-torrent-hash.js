 ...
 * @return {String}
 */
var read64LE = function read64LE(buffer, offset) {
 ...
 * @param length
 */
var checksumBuffer = function checksumBuffer(buf, length) {
    var checksum = 0,
        checksum_hex = 0;
...
* @return {String}
*/
var sumHex64bits = function sumHex64bits(n1, n2) {
 ...
 * @return {String}
 */
var padLeft = function padLeft(str, c, length) {
 ...
 * @return {Q.Promise}
 */
var computeMovieHash = function computeMovieHash(fileIndex, engine, callback) {
...
exports.computeHash = function (fileIndex, engine, callback) {
    return computeMovieHash(fileIndex, engine, callback);
};