...
function download(user, url, { filePath=null, is_check=true, referer=null, is_json=false, post=null, not_utf8=false, cookie=null, fake_ip=null, rest=null, errHandle=null, is_dm5=false, timeout=0, agent=false, accept=null } = {}) {
    let qspost = null;
    if (post) {
    ...
    let index = 0;
    const proc = () => Fetch(utf8.encode(url), Object.assign({cache: 'no-store'}, {headers: Object.assign(referer ? {'Referer': referer} : {}, user ? {} : agent ? agent : {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36'}, cookie ? {Cookie: cookie} : {}, accept ? accept : {}, qspost ? {
