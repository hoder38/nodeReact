...
export const SUPPORT_PRICE = [TUSDT_SYM, TBTC_SYM, TETH_SYM, TLTC_SYM, TOMG_SYM, TDOT_SYM, TSOL_SYM, TADA_SYM, TXRP_SYM, TAVAX_SYM, TTRX_SYM, TUNI_SYM];
