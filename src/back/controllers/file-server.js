...
//background
import { autoUpload, checkMedia/*, updateExternal*/, autoDownload, updateStock, filterStock, dbBackup, checkStock, rateCalculator, setUserOffer, filterBitfinex, checkSetOffer, usseInit, checkUsseInit, twseInit, checkTwseInit, updateStockList } from '../cmd/background.js'
//global
const credentials = {
