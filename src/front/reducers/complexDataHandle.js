...
import { SET_BITFINEX, BITFINEX_PUSH } from '../constants.js'
        ...
        switch (action.type) {
            ...
            if (action.sortName !== null && action.sortType !== null) {
                if (action.list === 'item') {
                    ...
                    return Object.assign({}, state, {
                        list: arrayObject('push', state.list, action.item, 'id',(set === SET_BITFINEX) ? rest_item2 : rest_item),
                ...
                if (action.pageToken === null) {
                    return Object.assign({}, state, {
                        ...
                        [action.list]: Object.assign({}, state[action.list], {
                            ...
                            list: arrayId('push', state[action.list].list, action.item, 'id',(set === SET_BITFINEX) ? rest_item2 : rest_item),
                        }),
                    })
                } else {
