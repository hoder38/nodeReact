...
export const SEND_GLB_PW = 'SEND_GLB_PW'
...
//stock
export const STOCK_PUSH = 'STOCK_PUSH'
export const STOCK_POP = 'STOCK_POP'
export const SET_STOCK = 'SET_STOCK'
export const SET_SDIRS = 'SET_SDIRS'
export const SDIR_POP = 'SDIR_POP'
